...
Kør projektet med `npm i` og `node index.js`.
Forbind det til backenden med at:
- Starte backenden (https://github.com/Lars007a/praktikting-backend).
- Ændre på URL'erne i `src/hooks/usePosts.jsx`, så at det passer med dit link.
